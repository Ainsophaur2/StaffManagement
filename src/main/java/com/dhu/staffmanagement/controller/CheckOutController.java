...
public class CheckOutController {
    ...
    public String addCheckOut(@RequestParam("name") String name,@RequestParam("currentPosition") String currentPosition,
                             @RequestParam("healthState") String healthState,@RequestParam("bodyTemperature") Double bodyTemperature,
                             @RequestParam("checkOutDate") Date checkOutDate,@RequestParam("isToHighArea") String isToHighArea,
    ...
    public String listByCureName(Model model, @RequestParam(name = "name", required = true) String name) {
        ...
        PageInfo<Administration> pageInfo = new PageInfo(checkOut);
        model.addAttribute("pageInfo", pageInfo);
        return "checkOutList";
    }
}
